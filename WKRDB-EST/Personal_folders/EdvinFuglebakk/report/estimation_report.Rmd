...
```{r estimate comparison, fig.cap="Design based estimates from the Herring lottery pilot (2018) with 95% confidence intervals. Point estimates from model based (ECA) estimates for same stock and year is overlayed", echo=F}
