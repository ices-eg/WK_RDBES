### David Currie function https://github.com/davidcurrie2001/MI_RDBES_ExchangeFiles/blob/master/RDBES_Functions.R
...
outputFolder <- "D:/WK_RDBES/WKRDB-EST2/subgroup4/personal/Kasia/output/"
...
loadReferenceData <- function(downloadFromICES = TRUE, validationData = NULL)
{
  ...
  if (downloadFromICES){
    ...
    saveRDS(allowedValues, file="D:/MI_RDBES_ExchangeFiles/referenceData/allowedValues.RDS")
    
  } else {
    # Just load from file
    allowedValues <- readRDS(file="D:/MI_RDBES_ExchangeFiles/referenceData/allowedValues.RDS")
  }
